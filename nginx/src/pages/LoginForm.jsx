...
const LoginForm = () => {
  // Login via Nginx em /auth/login -> /usuario/login no backend
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateForm()) {
        alerta('Por favor, corrija os erros no formulário.');
      return;
    }
    ...
    const loginSucesso = await LoginAction(formData, '/auth/login');
        
     if (loginSucesso && loginSucesso.accessToken) {
